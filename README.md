...
从销售凭证到售后结案，流程是：**政策与销售登记 → 退换申请 → 独立审核 → 收货检验 → 退款/换货登记 → 外部结果对账 → 结案**。业务动作写入 MySQL，拒绝分支不会生成虚假流水。
...
| 外部结果对账 | 登记外部退款/换货结果凭证，复核实付金额与内部应付金额一致；处理登记人与复核人分离，未对账不得结案。 |
...
系统登记退款/换货凭证并完成内部审批与结果对账，不会直接调用银行或支付平台扣/退款；对账所填外部凭证需由企业从实际渠道核实。真实资金划拨与 ERP/WMS 对接需在授权实施时接入并联调。
